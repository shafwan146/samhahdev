...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="meta-info" style="font-size: 0.8rem; color: var(--text-muted);">
                    ...
                    <div class="form-group">
                        ...
                        >
                            ...
                            @foreach($productTypes as $key => $label)
                                <option value="{{ $key }}" {{ old('product_type', $transaction->product_type) === $key ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        >
                            ...
                            @foreach($ageVariants as $key => $label)
                                <option value="{{ $key }}" {{ old('age_variant', $transaction->age_variant) === $key ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
